    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('CHV', 'Community Health Volunteer'), ('CLINICIAN', 'Clinician'), ('SPECIALIST', 'Specialist'), ('PATIENT', 'Patient'), ('ADMIN', 'Administrator')], max_length=20)),
